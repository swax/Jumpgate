...
export function drawGlowLayer(gfx: Graphics, width: number, height: number, fillColor: number): void {
  const cx = width / 2;
  const cy = height / 2;
...
export function drawNebulaBg(gfx: Graphics, width: number, height: number, fillColor: number): void {
  const cx = width / 2;
  const cy = height / 2;
